...
_s(Loader, "DhAt7yQCY8ATyOObTYFQf1q3nps=");
_c = Loader;
var _c;
...
function PageTransition({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PageTransition.useEffect": ()=>{
            ...
            }["PageTransition.useEffect.timer"], 1500); // 1.5 secondes de chargement minimum
            return ({
...
_s(PageTransition, "J7PPXooW06IQ11rfabbvgk72KFw=");
_c = PageTransition;
var _c;
...
const AuthProvider = ({ children })=>{
    ...
    const login = async (email, password)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5000/api") || "http://localhost:5000/api"}/auth/login`, {
                email,
                password
            }, {
                headers: {
    ...
    const register = async (userData)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5000/api") || "http://localhost:5000/api"}/auth/register`, userData, {
                headers: {
                    "Content-Type": "application/json"
                }
            });
    ...
    const logout = async ()=>{
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5000/api") || "http://localhost:5000/api"}/auth/logout`);
        } catch (error) {
            ...
            setUser(null);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success("Vous êtes déconnecté");
            router.push("/");
        }
    };
...
"[project]/src/app/components/RouteGuard.jsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function RouteGuard({ children }) {
    ...
    const { isAuthenticated, loading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$context$2f$AuthContext$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(RouteGuard, "kNOG7AcZojDed5UAzT2lbiA48ow=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=src_app_1acd2707._.js.map